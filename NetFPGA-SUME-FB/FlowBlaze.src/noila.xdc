...
create_clock -period 10.000 -name axi_clk -add [get_pins -hier -filter name=~*axi_clocking_i*clk_wiz_i/clk_out3]
...
set_property IOSTANDARD LVCMOS18 [get_ports {i2c_reset[0]}]
